movie 'boxing_gd_raw.swf' // flash 9, total frames: 21, frame rate: 12 fps, 600x380 px
  ...
  defineMovieClip 365 // total frames: 24
    ...
    frame 12
      constants 'next_match', 'retire', '_parent', 'can_retire', 'RETIRE', 'CONTINUE', 'mcSelecter', 'init', '', 'mes0', '同じパンチの連打は当たらない。異なるパンチでコンビネーションを組み立てろ。', 'mes1', 'フックとアッパーはラッキーパンチになることがあるぞ。', 'mes2', 'ボディブローは相手のスタミナをうばう。あとから効いてくるぞ。', 'mes3', 'ロープに追いつめるとパンチが当たりやすくなるぞ。', 'mes4', '連続でパンチを当てるとダメージが大きくなるぞ。', 'mes5', '疲れて肩で息をしている時はパンチが当たりやすい。', 'mes6', 'ジャブとボディは当てやすいが、ダウンを奪えない。', 'lang', 'You won\'t land hits by using the same punches. You need to mix them up in combinations.', 'Hooks and uppercuts sometimes land lucky hits.', 'Body blows sap your opponent\'s stamina, making it easier to knock them out.', 'When your opponent is up on the ropes, it\'s easier to land punches.', 'Consecutive hits cause more damage.', 'When your opponent is tired, it\'s easier to land punches.', 'It\'s easy to land jabs and body blows, but they won\'t knock your opponent down.', 'mes', 'this', 'Math', 'random', 'floor'  
     ...
     label3:
      ...
      pop
     label4:
      push 'mes0', '同じパンチの連打は当たらない。異なるパンチでコンビネーションを組み立てろ。'
      setVariable
      push 'mes1', 'フックとアッパーはラッキーパンチになることがあるぞ。'
      setVariable
      push 'mes2', 'ボディブローは相手のスタミナをうばう。あとから効いてくるぞ。'
      setVariable
      push 'mes3', 'ロープに追いつめるとパンチが当たりやすくなるぞ。'
      setVariable
      push 'mes4', '連続でパンチを当てるとダメージが大きくなるぞ。'
      setVariable
      push 'mes5', '疲れて肩で息をしている時はパンチが当たりやすい。'
      setVariable
      push 'mes6', 'ジャブとボディは当てやすいが、ダウンを奪えない。'
      setVariable
      push '_parent'
      getVariable
      push '_parent'
